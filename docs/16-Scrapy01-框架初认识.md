...
![同步和异步](./imgs/16-Scrapy01-框架初认识.assets/%E5%90%8C%E6%AD%A5%E5%92%8C%E5%BC%82%E6%AD%A5-2520822.png)
...
![爬虫流程-1](./imgs/16-Scrapy01-框架初认识.assets/%E7%88%AC%E8%99%AB%E6%B5%81%E7%A8%8B-1-2520822.png)

##### 4.2 上面的流程可以改写为

![爬虫流程-2](./imgs/16-Scrapy01-框架初认识.assets/%E7%88%AC%E8%99%AB%E6%B5%81%E7%A8%8B-2-2520822.png)

##### 4.3 scrapy的流程

![爬虫流程-3](./imgs/16-Scrapy01-框架初认识.assets/%E7%88%AC%E8%99%AB%E6%B5%81%E7%A8%8B-3-1047805-2520822.png)
...
![scrapy组件](./imgs/16-Scrapy01-框架初认识.assets/scrapy%E7%BB%84%E4%BB%B6-2520822.png)
...
scrapy当前最新版本为 2.11.0

scrapy-redis当前最新版本为  0.7.3

安装scrapy命令：

```
 pip install -i https://pypi.tuna.tsinghua.edu.cn/simple scrapy==2.11.0
...
2. 下载twisted安装包, https://www.lfd.uci.edu/~gohlke/pythonlibs/#twisted
   ...
   ![image-20210803144429440](./imgs/16-Scrapy01-框架初认识.assets/image-20210803144429440-2520822.png)
...
在控制台输入`scrapy version`能显示版本号. 则安装成功

**注意：**

如果当前运行`scrapy version`  显示`不是内部或外部命令，也不是可运行的程序或批处理文件。`

解决：

1. 升级pip 后重新安装
2. 如果还不行则安装scrapy后配置环境变量

参考

https://blog.csdn.net/hulabula/article/details/119725713
...
![scrapy入门使用-1](./imgs/16-Scrapy01-框架初认识.assets/scrapy%E5%85%A5%E9%97%A8%E4%BD%BF%E7%94%A8-1-2520822.png)
...
![scrapy入门使用-2](./imgs/16-Scrapy01-框架初认识.assets/scrapy%E5%85%A5%E9%97%A8%E4%BD%BF%E7%94%A8-2-2520822.png)
